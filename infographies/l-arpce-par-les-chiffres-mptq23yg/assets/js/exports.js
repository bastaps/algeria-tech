...
export function exportJSON() {
  downloadBlob(new Blob([JSON.stringify(DATASET, null, 2)], { type: 'application/json' }), 'l_arpce_par_les_chiffres_mptq23yg.json');
  toast('JSON exporté');
}
...
export async function exportPDF() {
  ...
  try {
    ...
    pdf.save('l_arpce_par_les_chiffres_mptq23yg.pdf');
    toast('PDF exporté');
