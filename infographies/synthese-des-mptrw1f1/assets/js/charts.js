/**
 * Graphiques Chart.js — Domain: rapport — Algeria Tech Generator v4
 */
...
function chartEvolution(ctx) {
  ...
  return new Chart(ctx, {
    ...
    data:{labels:ev.map(d=>d.periode),datasets:[
      {label:"Évolution annuelle",data:vals,borderColor:PALETTE[0],backgroundColor:PALETTE[0]+'18',tension:.35,pointRadius:5,pointBackgroundColor:PALETTE[0],pointBorderColor:'#111729',pointBorderWidth:2,fill:true},
